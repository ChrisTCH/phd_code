...
# squared, as well as Stokes Q and U, and calculates the tangential component #
# of the polarisation wavelength gradient. This produces an image of the      #
# tangential component. The formula is given on page 61 of PhD Logbook 5.     #
#                                                                             #
# Author: Chris Herron                                                        #
...
# Define the function calc_Tang_Wav_Grad, which will calculate the tangential 
# component of the polarisation wavelength gradient.
def calc_Tang_Wav_Grad(Q = None, U = None, dQ_dl = None, dU_dl = None):
    '''
    Description
        This function calculates the tangential component of the polarisation 
    ...
    Output
        tang_wav_grad - A Numpy array containing the value of the tangential
    ...
    # Calculate the tangential component of the polarisation wavelength gradient
    # at each pixel
    tang_wav_grad = -1.0 * np.sin(np.arctan2(U,Q)) * dQ_dl +\
                     np.cos(np.arctan2(U,Q)) * dU_dl
    
    # Return the tangential component of the polarisation wavelength gradient to
    # the caller
    return tang_wav_grad