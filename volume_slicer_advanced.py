...
Chris Herron Note (added 4/9/2014): 

This code was downloaded from
http://docs.enthought.com/mayavi/mayavi/auto/example_volume_slicer
_advanced.html?highlight=image_plane_widget on 4/9/2014. The author
of this code is not known, but below is the likely author, who
supplied a similar piece of code on the above website.
...
import volume_slicer_advanced as vs
m = vs.VolumeSlicer(data = data) # Creates the slicer object
m.configure_traits()             # Makes the slicer visible
"""
import numpy as np
