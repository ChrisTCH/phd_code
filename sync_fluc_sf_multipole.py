...
sync_fits = fits.open(data_loc + 'synint_p1-4z_alf.fits')
...
plt.title('Quad / Monopole z Alf {}'.format(spec_loc), fontsize = 20)

# Force the legend to appear on the plot
plt.legend(loc = 4)

# Save the figure using the given filename and format
plt.savefig(data_loc + 'Quad_Mono_Comp_z_alf.png', format = 'png')
...
# Add a title to the plot
plt.title('Octo / Monopole z Alf {}'.format(spec_loc), fontsize = 20)

# Force the legend to appear on the plot
plt.legend(loc = 4)

# Save the figure using the given filename and format
plt.savefig(data_loc + 'Octo_Mono_Comp_z_alf.png', format = 'png')
