...
plt.title(r'Mean vs $\zeta$ {}LOS'.format(line_o_sight[0]))
...
# Add a title to the plot
plt.title(r'Mean vs $\zeta$ {}LOS'.format(line_o_sight[1]))
...
# Add a title to the plot
plt.title(r'Mean vs $\zeta$ {}LOS'.format(line_o_sight[2]))
...
plt.errorbar(iter_array, mean_avg_arr[:,0,0],fmt='b-o',label= '{}'.format(\
	sim_labels[0]),yerr=mean_err_arr[:,0,0])
plt.errorbar(iter_array, mean_avg_arr[:,0,1],fmt='r-^',label= '{}'.format(\
	sim_labels[1]),yerr=mean_err_arr[:,0,1])
plt.errorbar(iter_array, mean_avg_arr[:,0,2],fmt='g-s',label= '{}'.format(\
	sim_labels[2]),yerr=mean_err_arr[:,0,2])
plt.errorbar(iter_array, mean_avg_arr[:,0,3],fmt='k-*',label= '{}'.format(\
	sim_labels[3]),yerr=mean_err_arr[:,0,3])
plt.errorbar(iter_array, mean_avg_arr[:,0,4],fmt='m-D',label= '{}'.format(\
...
# Add a title to the plot
plt.title('Mean vs ' + title_string + ' {}LOS'.format(line_o_sight[0]), fontsize = 20)
...
# Plot the mean as a function of the observational effect for simulations
plt.errorbar(iter_array, mean_avg_arr[:,1,0],fmt='b-o',label= '{}'.format(\
	sim_labels[0]),yerr=mean_err_arr[:,1,0])
plt.errorbar(iter_array, mean_avg_arr[:,1,1],fmt='r-^',label= '{}'.format(\
	sim_labels[1]),yerr=mean_err_arr[:,1,1])
plt.errorbar(iter_array, mean_avg_arr[:,1,2],fmt='g-s',label= '{}'.format(\
	sim_labels[2]),yerr=mean_err_arr[:,1,2])
plt.errorbar(iter_array, mean_avg_arr[:,1,3],fmt='k-*',label= '{}'.format(\
	sim_labels[3]),yerr=mean_err_arr[:,1,3])
plt.errorbar(iter_array, mean_avg_arr[:,1,4],fmt='m-D',label= '{}'.format(\
...
# Add a title to the plot
plt.title('Mean vs ' + title_string + ' {}LOS'.format(line_o_sight[1]), fontsize = 20)
...
# Plot the mean as a function of the observational effect for simulations
plt.errorbar(iter_array, mean_avg_arr[:,2,0],fmt='b-o',label= '{}'.format(\
	sim_labels[0]),yerr=mean_err_arr[:,2,0])
plt.errorbar(iter_array, mean_avg_arr[:,2,1],fmt='r-^',label= '{}'.format(\
	sim_labels[1]),yerr=mean_err_arr[:,2,1])
plt.errorbar(iter_array, mean_avg_arr[:,2,2],fmt='g-s',label= '{}'.format(\
	sim_labels[2]),yerr=mean_err_arr[:,2,2])
plt.errorbar(iter_array, mean_avg_arr[:,2,3],fmt='k-*',label= '{}'.format(\
	sim_labels[3]),yerr=mean_err_arr[:,2,3])
plt.errorbar(iter_array, mean_avg_arr[:,2,4],fmt='m-D',label= '{}'.format(\
...
# Add a title to the plot
plt.title('Mean vs ' + title_string + ' {}LOS'.format(line_o_sight[2]), fontsize = 20)
...
# Add a title to the plot
plt.title(r'StDev vs $\zeta$ {}LOS'.format(line_o_sight[0]))
...
# Add a title to the plot
plt.title(r'StDev vs $\zeta$ {}LOS'.format(line_o_sight[1]))
...
# Add a title to the plot
plt.title(r'StDev vs $\zeta$ {}LOS'.format(line_o_sight[2]))
...
plt.errorbar(iter_array, stdev_avg_arr[:,0,0],fmt='b-o',label= '{}'.format(\
	sim_labels[0]),yerr=stdev_err_arr[:,0,0])
plt.errorbar(iter_array, stdev_avg_arr[:,0,1],fmt='r-^',label= '{}'.format(\
	sim_labels[1]),yerr=stdev_err_arr[:,0,1])
plt.errorbar(iter_array, stdev_avg_arr[:,0,2],fmt='g-s',label= '{}'.format(\
	sim_labels[2]),yerr=stdev_err_arr[:,0,2])
plt.errorbar(iter_array, stdev_avg_arr[:,0,3],fmt='k-*',label= '{}'.format(\
	sim_labels[3]),yerr=stdev_err_arr[:,0,3])
plt.errorbar(iter_array, stdev_avg_arr[:,0,4],fmt='m-D',label= '{}'.format(\
...
# Add a title to the plot
plt.title('StDev vs ' + title_string + ' {}LOS'.format(line_o_sight[0]), fontsize = 20)
...
# simulations
plt.errorbar(iter_array, stdev_avg_arr[:,1,0],fmt='b-o',label= '{}'.format(\
	sim_labels[0]),yerr=stdev_err_arr[:,1,0])
plt.errorbar(iter_array, stdev_avg_arr[:,1,1],fmt='r-^',label= '{}'.format(\
	sim_labels[1]),yerr=stdev_err_arr[:,1,1])
plt.errorbar(iter_array, stdev_avg_arr[:,1,2],fmt='g-s',label= '{}'.format(\
	sim_labels[2]),yerr=stdev_err_arr[:,1,2])
plt.errorbar(iter_array, stdev_avg_arr[:,1,3],fmt='k-*',label= '{}'.format(\
	sim_labels[3]),yerr=stdev_err_arr[:,1,3])
plt.errorbar(iter_array, stdev_avg_arr[:,1,4],fmt='m-D',label= '{}'.format(\
...
# Add a title to the plot
plt.title('StDev vs ' + title_string + ' {}LOS'.format(line_o_sight[1]), fontsize = 20)
...
# Plot the mean as a function of the observational effect for simulations
plt.errorbar(iter_array, stdev_avg_arr[:,2,0],fmt='b-o',label= '{}'.format(\
	sim_labels[0]),yerr=stdev_err_arr[:,2,0])
plt.errorbar(iter_array, stdev_avg_arr[:,2,1],fmt='r-^',label= '{}'.format(\
	sim_labels[1]),yerr=stdev_err_arr[:,2,1])
plt.errorbar(iter_array, stdev_avg_arr[:,2,2],fmt='g-s',label= '{}'.format(\
	sim_labels[2]),yerr=stdev_err_arr[:,2,2])
plt.errorbar(iter_array, stdev_avg_arr[:,2,3],fmt='k-*',label= '{}'.format(\
	sim_labels[3]),yerr=stdev_err_arr[:,2,3])
plt.errorbar(iter_array, stdev_avg_arr[:,2,4],fmt='m-D',label= '{}'.format(\
...
# Add a title to the plot
plt.title('StDev vs ' + title_string + ' {}LOS'.format(line_o_sight[2]), fontsize = 20)
