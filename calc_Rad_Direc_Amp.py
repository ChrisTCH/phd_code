...
# the radial component. The formula is given on page 57 of PhD Logbook 2.     #
#                                                                             #
# Author: Chris Herron                                                        #
...
dU_dy = None, dU_dx = None, num_theta = 2):
    ...
    Required Input
        ...
        num_theta - The number of theta values for which to evaluate the 
                    amplitude of the radial component of the directional
    ...
    # Iterate through the different values of theta for which the radial
    ...
    # Calculate the amplitude of the radial component of the directional
    # derivative at each pixel by taking the absolute value of the radial
    # component image cube, and then calculating the maximum over the theta 
    # axis.
    rad_comp_amp = np.amax(np.abs(rad_comp),0)
    
    # Delete the radial component image cube, so that it doesn't take up 
    # memory
    del rad_comp
