...
# radial component of the directional derivative of the complex               #
# polarisation vector. This amplitude is the maximum absolute value of the    #
# radial component over a range of angles theta with respect to the           #
# horizontal axis of the image. This produces an image of the amplitude of    #
# the radial component. The formula is given on page 34 of PhD Logbook 5.     #
#                                                                             #
# Author: Chris Herron                                                        #
...
# Define the function calc_Rad_Direc_Amp, which will calculate the amplitude of
# the radial component of the directional derivative of the complex 
# polarisation vector. This amplitude is the maximum absolute value of the    
# radial component over a range of angles theta with respect to the       
# horizontal axis of the image.
def calc_Rad_Direc_Amp(Q = None, U = None, dQ_dy = None, dQ_dx = None,\
dU_dy = None, dU_dx = None):
    '''
    Description
        This function calculates the amplitude of the radial component of 
        ...
        radial component over a range of angles theta with respect to the
        horizontal axis of the image. The formula is given on page 34 of PhD
        Logbook 5.
    ...
    Output
        rad_comp_amp - A Numpy array containing the value of the amplitude of 
    ...
    # Calculate the numerator needed to calculate the radial component of the 
    # directional derivative
    numer = np.power(Q*dQ_dx + U*dU_dx,2.0) + np.power(Q*dQ_dy + U*dU_dy,2.0)

    # Calculate the denominator needed to calculate the radial component of the
    # directional derivative
    denom = np.power(Q,2.0) + np.power(U,2.0)

    # Calculate the maximum amplitude of the radial component of the directional
    # derivative at each pixel
    rad_comp_amp = np.sqrt(numer/denom)
    
    # Return the amplitude of the radial component of the directional derivative
    # to the caller
    return rad_comp_amp