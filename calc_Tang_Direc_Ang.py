...
# plane for which the tangential component of the directional derivative of   #
# the complex polarisation vector is maximised. This produces an image of the #
# angle for which the tangential component is maximised. The formula is given #
# on page 34 of PhD Logbook 5.                                                #
#                                                                             #
# Author: Chris Herron                                                        #
...
# Define the function calc_Tang_Direc_Ang, which will calculate the angle in the
# image plane for which the tangential component of the directional derivative 
# of the complex  polarisation vector is maximised. 
def calc_Tang_Direc_Ang(Q = None, U = None, dQ_dy = None, dQ_dx = None,\
dU_dy = None, dU_dx = None):
    '''
    Description
        This function calculates the angle for which the tangential component of 
        ...
        as Stokes Q and U themselves. The formula is given on page 34 of PhD
        Logbook 5.
    ...
    Output
        tang_comp_ang - A Numpy array containing the value of the angle for which 
