#-----------------------------------------------------------------------------#
#                                                                             #
# This piece of code is a script that produces Figure 7 of the paper on the   #
...
# Galactic plane mosaic of the CGPS, along with the skewness of the gradient. #
#                                                                             #
# Author: Chris Herron                                                        #
...
fig1 = aplpy.FITSFigure(cgps_gradP_150_fits, figure=fig_a, subplot=[0.1,0.7,0.8,0.22],\
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig2 = aplpy.FITSFigure(cgps_skew_150_fits, figure=fig_a, subplot=[0.1,0.55,0.8,0.22],\
 convention = convention)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig3 = aplpy.FITSFigure(cgps_gradP_150_fits, figure=fig_a, subplot=[0.1,0.35,0.8,0.22],\
 convention = convention)
...
# Make a colour scale version of the image appear on the frame, 
# using the colour map specified by the user
fig3.show_colorscale(vmin = vmin_p,vmax=vmax_p,cmap=colour_p, stretch=stretch_p)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig4 = aplpy.FITSFigure(cgps_skew_150_fits, figure=fig_a, subplot=[0.1,0.20,0.8,0.22],\
 convention = convention)

# Change the figure so that only the desired region is plotted
fig4.recenter(155.0,1.0,width=28.0,height=8.5)

# In this case the colour scale range is set manually using the 
# specified values for vmin and vmax
# Make a colour scale version of the image appear on the frame, 
# using the colour map specified by the user
fig4.show_colorscale(vmin=vmin_s, vmax=vmax_s, cmap = colour_s, stretch = stretch_s)
...
fig4.tick_labels.set_yformat('ddd.d')
...
plt.figtext(0.53, 0.195, 'Galactic Longitude', ha = 'center', \
...
fig_a.savefig(filename + 'fig7a.eps', dpi = save_dpi, format = 'eps', bbox_inches='tight')
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig1 = aplpy.FITSFigure(cgps_gradP_150_fits, figure=fig_b, subplot=[0.1,0.7,0.8,0.22],\
 convention = convention)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig2 = aplpy.FITSFigure(cgps_skew_150_fits, figure=fig_b, subplot=[0.1,0.55,0.8,0.22],\
 convention = convention)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig3 = aplpy.FITSFigure(cgps_gradP_150_fits, figure=fig_b, subplot=[0.1,0.35,0.8,0.22],\
 convention = convention)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig4 = aplpy.FITSFigure(cgps_skew_150_fits, figure=fig_b, subplot=[0.1,0.20,0.8,0.22],\
 convention = convention)

# Change the figure so that only the desired region is plotted
fig4.recenter(109.0,1.0,width=28.0,height=8.5)
...
# Save the image using the given filename
fig_b.savefig(filename + 'fig7b.eps', dpi = save_dpi, format = 'eps', bbox_inches='tight')
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig1 = aplpy.FITSFigure(cgps_gradP_150_fits, figure=fig_c, subplot=[0.1,0.7,0.8,0.22],\
 convention = convention)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig2 = aplpy.FITSFigure(cgps_skew_150_fits, figure=fig_c, subplot=[0.1,0.55,0.8,0.22],\
 convention = convention)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig3 = aplpy.FITSFigure(cgps_gradP_150_fits, figure=fig_c, subplot=[0.1,0.35,0.8,0.22],\
 convention = convention)
...
# The subplot argument gives (xmin,ymin,dx,dy), for placement of the subplot
# Need a 10 percent margin on each side of the figure
fig4 = aplpy.FITSFigure(cgps_skew_150_fits, figure=fig_c, subplot=[0.1,0.20,0.8,0.22],\
 convention = convention)

# Change the figure so that only the desired region is plotted
fig4.recenter(63.0,1.0,width=28.0,height=8.5)
...
# Save the image using the given filename
fig_c.savefig(filename + 'fig7c.eps', dpi = save_dpi, format = 'eps', bbox_inches='tight')
